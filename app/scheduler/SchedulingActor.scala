...
object SchedulingActor {
  ...
  case class HandleNotProcessedFilesFromSDESMessage(service: HandleStuckNotificationsService) extends ScheduledMessage[Either[ScheduleStatus.JobFailed, String]]
}
