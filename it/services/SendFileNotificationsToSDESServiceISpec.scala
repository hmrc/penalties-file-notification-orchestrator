...
class SendFileNotificationsToSDESServiceISpec extends IntegrationSpecCommonBase {
  class Setup {
    val lockRepositoryProviderRepo: LockRepository = app.injector.instanceOf[LockRepositoryProvider].repo
    val service: SendFileNotificationsToSDESService = app.injector.instanceOf[SendFileNotificationsToSDESService]
